...
app.post('/getBalance',function(req,res){
  var result = {
    "loadbalanceInfoOut":[
      ...
      {"name":"Ib8","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
        "createTime":"2017.x.x"},
      {"name":"Ib90","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
        "createTime":"2017.x.x"},
      {"name":"Ib1","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
        "createTime":"2017.x.x"},
      {"name":"Ib2","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
      ...
      {"name":"Ib8","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
        "createTime":"2017.x.x"},
      {"name":"Ib900","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
        "createTime":"2017.x.x"}
    ],
    "loadbalanceInfoIn":[
      {"name":"Ib1","balance":"app1","dns":"xxx.xxx.xxx.xxx","protocol":"tcp","port":"50","state":"running" ,
